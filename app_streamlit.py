...
def main():
    ...
    st.markdown("""
    <h1 style='text-align: center; margin-bottom: 0;'>🎭 EMOTION AI</h1>
    <p style='text-align: center; color: #a0aec0; font-size: 1.2rem; margin-top: 0.5rem;'>
        Deep Learning Powered Facial Emotion Recognition
    </p>
    """, unsafe_allow_html=True)
    ...
    <div style='text-align: center; color: #6b7280; padding: 2rem;'>
        <p style='font-size: 0.95rem;'>
            🤖 Built with PyTorch • ResNet50 • Streamlit<br>
            📊 Trained on FER2013 Dataset (35,000+ expressions)<br>
            ⚡ ~80% Accuracy • <100ms Inference Time
        </p>
    </div>
    """, unsafe_allow_html=True)
